...
goalImage = img`
    . . . . 8 8 8 8 8 8 8 8 . . . .
    . . . 8 9 9 9 9 9 9 9 9 8 . . .
    . . 8 9 1 1 1 1 1 1 1 1 9 8 . .
    . 8 9 1 8 8 8 8 8 8 8 8 1 9 8 .
    8 9 1 8 9 9 9 9 9 9 9 9 8 1 9 8
    8 9 1 8 9 1 1 1 1 1 1 9 8 1 9 8
    8 9 1 8 9 1 8 8 8 8 1 9 8 1 9 8
    8 9 1 8 9 1 8 . . 8 1 9 8 1 9 8
    8 9 1 8 9 1 8 . . 8 1 9 8 1 9 8
    8 9 1 8 9 1 8 8 8 8 1 9 8 1 9 8
    8 9 1 8 9 1 1 1 1 1 1 9 8 1 9 8
    8 9 1 8 9 9 9 9 9 9 9 9 8 1 9 8
...
enemy1 = sprites.create(enemyImage, SpriteKind.Enemy)
tiles.placeOnTile(enemy1, tiles.getTileLocation(7, 6))
enemy1.vx = 30
enemy2 = sprites.create(enemyImage, SpriteKind.Enemy)
tiles.placeOnTile(enemy2, tiles.getTileLocation(9, 6))
enemy2.vx = -25
goal = sprites.create(goalImage, SpriteKind.Goal)
tiles.placeOnTile(goal, tiles.getTileLocation(18, 6))
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    sprite.vy = 0
    tiles.placeOnTile(sprite, tiles.getTileLocation(2, 6))
    pause(1000)
...
game.onUpdateInterval(100, function () {
    if (enemy1.x < 104) {
        enemy1.vx = 30
    } else if (enemy1.x > 136) {
        enemy1.vx = -30
    }
    if (enemy2.x < 120) {
        enemy2.vx = 25
    } else if (enemy2.x > 152) {
        enemy2.vx = -25
    }
})
